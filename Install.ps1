...
docker build -f Corporate.Systems.Apllications.Application1\Docker\Dockerfile --force-rm -t console-app1-demo .

# Create Application2 console-app2 image
docker build -f Corporate.Systems.Apllications.Application2\Docker\Dockerfile --force-rm -t console-app2-demo .
