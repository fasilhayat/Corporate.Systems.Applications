...
# Create Application3 console-app3 image
docker build -f Corporate.Systems.Applications.Application3\Docker\Dockerfile --force-rm -t console-app3-demo .
...
docker compose -f Corporate.Systems.Applications.Application3\Docker\docker-compose.yml -p app3 up -d --build
